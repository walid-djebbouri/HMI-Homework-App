...
public class Main4Activity extends AppCompatActivity {
    ...
    public  void eng(View view){
        ...
        db.insertion( nom ,"expert" ,  incitation  ,  groupement , feedback  , lisibilité   ,  brièvité   , densité  ,  experience  ,  erreur  ,  message  , correction  , controle  ,  utilisateur  , cohérence  ,   sinification ,  compatibilité );
