...
public class Main5Activity extends AppCompatActivity {
    ...
    public  void eng(View view){
        ...
        db.insertion( nom ,"habitué" ,  incitation  ,  groupement , feedback  , lisibilité   ,  brièvité   , densité  ,  experience  ,  erreur  ,  message  , correction  , controle  ,  utilisateur  , cohérence  ,   sinification ,  compatibilité );
